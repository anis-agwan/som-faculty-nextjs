      ...
      <div className="flex justify-center">
        <div className="flex w-5/6 ">
          <div className="flex w-full flex-col  gap-8 pb-6">
            <h1 className="titleText self-center">Section 3 </h1>
            <div className="bg-white p-6 rounded-md border-2 w-fullshadow-sm ">
              <div className="flex gap-2">
                <p className="sectionTitle ">Past Behavior Questions</p>
              </div>
              <div>
                <br />
                <i className="instructionTextItalic ">
                  Make your ratings for the adapting to change on the
                  adaptability evaluation form.
                </i>
              </div>
            </div>
            <div className="bg-white p-6 rounded-md border-2 w-full shadow-sm ">
              <div className="flex flex-col gap-2">
                <p className="sectionTitle ">Adapting to Change</p>
              </div>
                      ...
                      <div className="bg-lime-300 p-8 rounded-md">
                        <ol className="flex flex-col gap-4 px-10 instructionText">
                          <li>
                            ...
                            departmental priorities. What were they, and how did
                            you cope with them?
                          </li>
                          <li>
                            2. What are the most stressful aspects of your
                            current/last job? Why were they stressful? Give me
                            an example of a recent time when this stressful
                            situation occurred. What did you do?
                          </li>
                          <li>
                            3. Working effectively with a new supervisor,
                            employee, or work team can sometimes be challenging.
                            Tell me about a time when you found it difficult to
                            get used to a new person or team. How did things
                            turn out?
                          </li>
                        </ol>
                      </div>
            ...
            <div className="self-center w-1/3">
              ...
              >
                <StartButton buttonText={"Section 4"} />
              </Link>
            </div>
          </div>
        </div>
